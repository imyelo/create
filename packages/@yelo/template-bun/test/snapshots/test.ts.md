...
> content of .husky/pre-commit
    ...
    `bunx biome check --fix --files-ignore-unknown=true␊
    `
...
> content of biome.json

    `{␊
      "$schema": "https://biomejs.dev/schemas/2.3.14/schema.json",␊
      "extends": ["@yelo/biome-config"],␊
      "vcs": {␊
        "enabled": true,␊
        "clientKind": "git",␊
        "useIgnoreFile": true␊
...
> content of tsconfig.json
    ...
    `{␊
      ...
      "include": ["tsconfig.json", "tsconfig.esm.json", "src", "test"]␊
    }␊
    `
